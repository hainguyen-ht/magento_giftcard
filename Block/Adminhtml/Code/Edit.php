...
class Edit extends \Magento\Backend\Block\Widget\Form\Container
{
    ...
    protected function _construct()
    {
        ...
        $this->buttonList->update('save', 'label', __('Save Gift Card'), 'id');
        $this->buttonList->add(
            'saveandcontinue',
            [
    ...
    {
        if ($this->_coreRegistry->registry('giftcard_form_data')->getId()) {
            return __("Edit Gift Card '%1'", $this->escapeHtml($this->_coreRegistry->registry('giftcard_form_data')->getTitle()));
        } else {
